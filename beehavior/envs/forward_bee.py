"""
implements class for moving forward in a tunnel while avoiding obstacles
"""
...
class ForwardBee(OFBeeseClass):
    ...
    def get_rwd(self, collided, obs):
        """
        -1 for colliding, -.5 for out of bounds, otherwise gives reward for advancing in the tunnel
        """
        info_dic = {'succ': False}
        if collided:
            return -1., info_dic
    ...
    def reset(
        ...
        """
        reset, resets the tracker for farthest reached
        """
